...
fact([nextInWay,X,Y1,Z1],add,Q1,_), fact([nextInWay,X,Y2,Z2],add,Q2,_) <=>
	Z1 \== Z2 |
	fact([nextInWay,X,Y1,Z1],prv,Q1,_), 
	fact([nextInWay,X,Y2,Z2],prv,Q2,_),
	applied_rules(1,bwd).	
fact([connection,Z1,Z2],chk,_,_), fact([nextInWay,X,_,Z1],prv,_,_) \
fact([nextInWay,X,Y2,Z2],add,Q2,_) <=>
	Z1 \== Z2 | 
	fact([nextInWay,X,Y2,Z2],prv,Q2,_),
	applied_rules(1,bwd).		
fact([connection,Z1,Z2],chk,_,_), fact([nextInWay,X,_,Z2],prv,_,_) \
fact([nextInWay,X,Y1,Z1],add,Q1,_) <=>
	Z1 \== Z2 | 
	fact([nextInWay,X,Y1,Z1],prv,Q1,_),
	applied_rules(1,bwd).		
	...
	% X,_ + _,X
fact([connection,Z1,Z2],chk,_,_) \ 
fact([nextInWay,X,Y1,Z1],add,Q1,_), fact([nextInWay,Y2,X,Z2],add,Q2,_) <=>
	Z1 \== Z2 |
	fact([nextInWay,X,Y1,Z1],prv,Q1,_), 
	fact([nextInWay,Y2,X,Z2],prv,Q2,_),
	applied_rules(1,bwd).	
fact([connection,Z1,Z2],chk,_,_), fact([nextInWay,X,_,Z1],prv,_,_) \
fact([nextInWay,Y2,X,Z2],add,Q2,_) <=>
	Z1 \== Z2 | 
	fact([nextInWay,Y2,X,Z2],prv,Q2,_),
	applied_rules(1,bwd).		
...
fact([nextInWay,X,Y1,Z1],add,Q1,_) <=>
	...
	% _,X + _,X
fact([connection,Z1,Z2],chk,_,_) \ 
fact([nextInWay,Y1,X,Z1],add,Q1,_), fact([nextInWay,Y2,X,Z2],add,Q2,_) <=>
	Z1 \== Z2 |
	fact([nextInWay,Y1,X,Z1],prv,Q1,_), 
	fact([nextInWay,Y2,X,Z2],prv,Q2,_),
	applied_rules(1,bwd).	
...
fact([nextInWay,Y2,X,Z2],add,Q2,_) <=>
	...
	applied_rules(1,bwd).		
fact([connection,Z1,Z2],chk,_,_), fact([nextInWay,_,X,Z2],prv,_,_) \
fact([nextInWay,Y1,X,Z1],add,Q1,_) <=>
	Z1 \== Z2 | 
	fact([nextInWay,Y1,X,Z1],prv,Q1,_),
	applied_rules(1,bwd).	
...
fact([connection,X,Y],add,Q1,_), fact([connection,Y,Z],add,Q2,_) <=>
	fact([connection,X,Y],chk,Q1,_), 
	fact([connection,Y,Z],chk,Q2,_),
	applied_rules(1,bwd).	
	
fact([connection,X,Z],chk,_,_) \ 	
fact([connection,X,Y],dly,Q1,_), fact([connection,Y,Z],dly,Q2,_) <=>
	fact([connection,X,Y],prv,Q1,_), 
	fact([connection,Y,Z],prv,Q2,_),
	applied_rules(1,bwd).	
	
fact([connection,X,Z],chk,_,_) \ 	
fact([connection,X,Y],add,Q1,_), fact([connection,Y,Z],dly,Q2,_) <=>
	fact([connection,X,Y],chk,Q1,_), 
	fact([connection,Y,Z],prv,Q2,_),
	applied_rules(1,bwd).	
	
fact([connection,X,Z],chk,_,_) \ 	
fact([connection,X,Y],dly,Q1,_), fact([connection,Y,Z],add,Q2,_) <=>
	fact([connection,X,Y],prv,Q1,_), 
	fact([connection,Y,Z],chk,Q2,_),
	applied_rules(1,bwd).	
	
fact([connection,X,Z],chk,_,_), fact([connection,X,Y],prv,_,_) \
fact([connection,Y,Z],add,Q2,_) <=>
	fact([connection,Y,Z],chk,Q2,_),
	applied_rules(1,bwd).		
	
fact([connection,X,Z],chk,_,_), fact([connection,Y,Z],prv,_,_) \
fact([connection,X,Y],add,Q1,_) <=>
	fact([connection,X,Y],chk,Q1,_),
	applied_rules(1,bwd).		
	
fact([connection,X,Z],chk,_,_), fact([connection,X,Y],prv,_,_) \
fact([connection,Y,Z],dly,Q2,_) <=>
	fact([connection,Y,Z],prv,Q2,_),
	applied_rules(1,bwd).		
	
fact([connection,X,Z],chk,_,_), fact([connection,Y,Z],prv,_,_) \
fact([connection,X,Y],dly,Q1,_) <=>
	fact([connection,X,Y],prv,Q1,_),
	applied_rules(1,bwd).		
...
fact([nextInWay,X,_,Z1],prv,_,_), fact([nextInWay,X,_,Z2],prv,_,_) \ fact([connection,Z1,Z2],chk,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],prv,Q1,_),
	applied_rules(1,fwd).

fact([nextInWay,X,_,Z1],prv,_,_), fact([nextInWay,_,X,Z2],prv,_,_)  \ fact([connection,Z1,Z2],chk,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],prv,Q1,_),
	applied_rules(1,fwd).
	
fact([nextInWay,_,X,Z1],prv,_,_), fact([nextInWay,X,_,Z2],prv,_,_)  \ fact([connection,Z1,Z2],chk,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],prv,Q1,_),
	applied_rules(1,fwd).	
	
fact([nextInWay,_,X,Z1],prv,_,_), fact([nextInWay,_,X,Z2],prv,_,_) \ fact([connection,Z1,Z2],chk,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],prv,Q1,_),
	applied_rules(1,fwd).	
...
phase(1), fact([nextInWay,X,_,Z1],prv,_,_), fact([nextInWay,X,_,Z2],prv,_,_) 
\ fact([connection,Z1,Z2],add,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],dly,Q1,_),
	applied_rules(1,fwd).

phase(1), fact([nextInWay,X,_,Z1],prv,_,_), fact([nextInWay,_,X,Z2],prv,_,_)  
\ fact([connection,Z1,Z2],add,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],dly,Q1,_),
	applied_rules(1,fwd).
	
phase(1), fact([nextInWay,_,X,Z1],prv,_,_), fact([nextInWay,X,_,Z2],prv,_,_)  
\ fact([connection,Z1,Z2],add,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],dly,Q1,_),
	applied_rules(1,fwd).	
	
phase(1), fact([nextInWay,_,X,Z1],prv,_,_), fact([nextInWay,_,X,Z2],prv,_,_) 
\ fact([connection,Z1,Z2],add,Q1,_) <=>
	Z1 \== Z2 |
	fact([connection,Z1,Z2],dly,Q1,_),
	applied_rules(1,fwd).	
	
phase(1), fact([connection,X,Y],prv,_,_), fact([connection,Y,Z],prv,_,_) 
\ fact([connection,X,Z],add,Q1,_) <=>
...
fact([nextInWay,X,_,Z1],add,Q1,_), fact([nextInWay,X,_,Z2],add,Q2,_)  ==>
	Z1 \== Z2,
	member(Q, [Q1, Q2]) |
	derived_fact([connection,Z1,Z2],Q,_).
phase(3), current_query(Q),
fact([nextInWay,X,_,Z1],add,Q1,_), fact([nextInWay,_,X,Z2],add,Q2,_)  ==>
	Z1 \== Z2,
	member(Q, [Q1, Q2]) |
	derived_fact([connection,Z1,Z2],Q,_).
phase(3), current_query(Q),
fact([nextInWay,_,X,Z1],add,Q1,_), fact([nextInWay,X,_,Z2],add,Q2,_)  ==>
	Z1 \== Z2,
	member(Q, [Q1, Q2]) |
	derived_fact([connection,Z1,Z2],Q,_).
phase(3), current_query(Q),
fact([nextInWay,_,X,Z1],add,Q1,_), fact([nextInWay,_,X,Z2],add,Q2,_)  ==>
	Z1 \== Z2,
	member(Q, [Q1, Q2]) |
	derived_fact([connection,Z1,Z2],Q,_).	
phase(3), current_query(Q),
